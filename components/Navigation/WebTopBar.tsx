...
export default function WebTopBar() {
    ...
    return (
        <View className="w-full bg-white border-b border-gray-100 sticky top-0 z-50">
            <View className="flex-row items-center justify-between px-4 py-4 max-w-2xl mx-auto w-full">
                {/* Logo area */}
                ...
                {/* Navigation Links */}
                <View className="flex-row items-center space-x-8 gap-8">
                    <TouchableOpacity onPress={() => router.push('/')} className="flex-row items-center">
                ...
                {/* Right Action Area - Currently Empty, reserved for future use (e.g. Notifications) */}
                <View className="flex-row items-center gap-4 w-8">
                    {/* Placeholder to balance the layout if needed, or just empty */}
                </View>
            </View>
        </View>
    );
